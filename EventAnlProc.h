   ...
   public:
     ...
     // AidaAnlData    pAida;
      ...
      void get_used_systems();
        ...
        double lead_lead_bplas_Ref3[16][10];
    ...
    long stopTime;
      ...
      /* Multiplexer correction */
            ...
            TH1 *hbPlas_ToT_det[4][32];
            
            TH1 *hbPlas_Lead_T[4][16];
            TH1 *hbPlas_Trail_T[4][16];
            TH1 *hbPlas_Multiplicity_Det1;
            TH1 *hbPlas_Multiplicity_Det2; 
            TH1 *hbPlas_Multiplicity_Det3; 
           
            //TH1 *hbPlas_lead_lead[3][32];
            TH1 *hbPlas_lead_lead_ref_det1[4][16];
            TH1 *hbPlas_lead_lead_ref_det2[4][16];
            TH1 *hbPlas_lead_lead_ref_det3[4][16];
            TH1 *hbPlas_lead_lead_gated[4][32];       
            TH1 *hbPlas_ToT[4][32];
//             TH1 *hbPlas_ToT_coinc[3][32];
//             TH1 *hbPlas_ToT_coinc_dets[3][32];
//             TH1 *hbPlas_ToT_coinc_dets_perchan[3][32];
            TH1 *hbPlas_trail_trail[4][32];
            TH1 *hbPlas_Energy_Calib[4][32];
            TH1 *hbPlas_SC41L_Anal_lead[4][32];
            TH1 *hbPlas_SC41R_Anal_lead[4][32];
            TH1 *hbPlas_SC41L_Digi_lead[4][32];
            TH1 *hbPlas_SC41R_Digi_lead[4][32];
	    ...
	    TH2 *hFIMP_ToT_Correlation_Comb2;
            ...
            TH1 *hGAL_Chan_E_halfkev[GALILEO_MAX_DETS][GALILEO_CRYSTALS];
            //TH1 *hGAL_Chan_E2;
            TH1 *hGAL_Chan_Egate;
            TH1 *hGAL_AddbackSum;
            TH1 *hGAL_AddbackSum_halfkev;
            TH1 *hGAL_dTaddback;
            TH1 *hGAL_ESum_SC41;
            TH1 *hGAL_Chan_Time_Diff[32];
            TH1 *hGAL_Time_Diff_vs_Energy[32];
            TH1 *hGAL_ESum;
            TH1 *hGAL_ESum_halfkev;
