...
//       std::vector<std::vector<TH1*>> hA_FRS_ZAoQ_implants_e_gate;
     ...
     // std::vector<TH2*> hA_FRS_Z1Z2_x2x4AoQ_implants_e_xy;
      ...
      TH1 *hA_FRSWR_GalWR;
      TH1 *hA_FRS_GalE;
      TH1 *hA_FRS_PID_GalE[8];
      TH1 *hA_FRS_Z1Z2_X2AoQX4AoQ_GalE[8];
      TH2 *hA_FRS_GalEvsT[8];
      TH2 *hA_SC41_GalEvsT[8];
      
      TH1 *hA_bPlasWR_GalWR;
      TH1 *hA_BplasDet1_GalE;
      TH1 *hA_BplasDet2_GalE;
      
      TH1 *hA_bPlasWR_FatWR;
      TH1 *hA_BplasDet1_FatE;
      TH1 *hA_BplasDet2_FatE;
      ...
      TH1 *hFibre_FRS_AoQ[16];
      TH1 *hFibre_FRS_all[16];
